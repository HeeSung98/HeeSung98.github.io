...
조회 페이지에서 목록 페이지로 돌아갈 때 또한 검색 조건을 추가합니다.<br>
read.html의 Modify와 ToList 버튼에 type과 keyword를 넘기도록 작성합니다.<br>

# 17. read.html 검색 조건 추가
---
<br>
