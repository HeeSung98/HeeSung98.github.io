...
Ajax를 이용해 POST 방식으로 전달된 댓글을 컨트롤러에서 @PostMapping을 통해 처리하도록 작성합니다.<br>
...
DELETE 방식으로 전달된 댓글의 번호를 ReplyController에서 @DeleteMapping으로 처리합니다.<br>
...
Ajax를 이용해 PUT 방식으로 전달된 댓글을 컨트롤러에서 @PutMapping을 통해 처리하도록 작성합니다.<br>
